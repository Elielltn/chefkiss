function InputArea() {
  return (
    <div className="flex items-center justify-between mb-[36px]">
      ...
      />
      <button className="bg-[#593700] rounded-[999px]">
        <svg
          width="50"
          height="50"
          viewBox="0 0 50 50"
        ...
        >
          <path d="M25 12.5L25 37.5" stroke="#FFD6A8" stroke-linecap="round" />
          <path d="M37.5 25L12.5 25" stroke="#FFD6A8" stroke-linecap="round" />
        </svg>
      </button>
    </div>
  );
